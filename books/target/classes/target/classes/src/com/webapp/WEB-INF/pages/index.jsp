...
<div id="main">
    ...
    <div class="topbar-right" th:if="${session.surrUser==null}">
        <a th:href="@{/page.do?operate=page&page=user/login}" class="login">登录</a>
        <a th:href="@{/page.do?operate=page&page=user/regist}" class="regist">注册</a>
        <a th:href="@{/page.do?operate=page&page=cart/cart}" class="cart">购物车
            <div class="cart-num"></div>
        </a>
        <a th:href="@{/page.do?operate=page&page=manager/book_manager}" class="admin">后台管理</a>
    </div>
    <div class="topbar-right" th:unless="${session.surrUser==null}">
        <span>欢迎你<b th:text="${session.currUser.getUname()}"></b></span>
        <a th:href="@{/page.do?operate=page&page=user/register}" class="register">注销</a>
        <a th:href="@{/page.do?operate=page&page=cart/cart}" class="cart">购物车
