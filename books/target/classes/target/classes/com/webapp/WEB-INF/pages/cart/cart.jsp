...
<body>
    ...
    <div>
        <table>
            <tr th:each="cartItem : ${session.currUser.cart.cartItemMap.values()}" th:object="${cartItem}">
                <td><img th:src="@{|/static/*{book.bookImg}|}"></td>
                <td th:text="*{book.bookName}"></td>
                <td>
                   <span></span>
                    <input class="count-num" type="text"  th:value="*{buyCount}">
                   <span></span>
                </td>
                <td th:text="*{book.price}"></td>
                <td th:text="*{book.price*buyCount}"></td>
                <td><a href="">删除</a></td>
            </tr>
        </table>
    </div>
